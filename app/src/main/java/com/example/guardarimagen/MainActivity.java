...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn2 = findViewById(R.id.btnAgregarImagen);
       ...
       // byte[] sFoto = Base64.decodeBase64(item.getFoto());
         sFoto = Base64.decodeBase64(imagen);
        imagenAlmacenada = setImage(sFoto);
   ...
   private Bitmap setImage(byte[] data) {
    ...
    private void registrarusuarios() {
        Bitmap bitmap = imagenAlmacenada;
        int id = 15;
       ...
       // id.getText().toString();
        ...
        Log.i("AQUI", String.valueOf(blob.length));
        // fin guardar imagen
        ...
        private void agregarImagen() {
          ...
          //  File directory = new File(Environment.getDataDirectory() + "/nuevo");
            //File directory = Environment.getDataDirectory();
            File directory = getFilesDir();
            Log.d("vamos", String.valueOf(Environment.DIRECTORY_PICTURES));
            if (!directory.exists()) {
                directory.mkdir();
            }
